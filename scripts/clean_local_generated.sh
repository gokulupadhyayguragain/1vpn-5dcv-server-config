...
rm -f "$ROOT_DIR/ansible/inventories/hosts.ini" "$ROOT_DIR/ansible/inventories/hosts.yml"
...
if [[ "$include_artifacts" == "true" ]]; then
  echo "REMOVED: ansible/inventories/hosts.ini, ansible/inventories/hosts.yml, terraform/backend_override.tf, artifacts/"
else
  echo "REMOVED: ansible/inventories/hosts.ini, ansible/inventories/hosts.yml, terraform/backend_override.tf"
